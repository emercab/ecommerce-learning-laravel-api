                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="mpx-10">
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="text-12 c-grey l-grey a-right py-20"
                            ...
                            <webversion class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span
                                class="link c-grey" style="text-decoration:none; color:#6e6e6e;">View this email in your
                                browser</span></webversion>
                          </td>
                        </tr>
                      </table> <!-- END Top -->
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="gradient pt-10" style="border-radius: 10px 10px 0 0; padding-top: 10px;"
                            bgcolor="#f3189e">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                    ...
                                    <tr>
                                      <td class="img-center p-30 px-15"
                                        ...
                                        <a href="https://laravest.com/" target="_blank"><img
                                            ...
                                            style="background: black;border-radius: 5px;" width="112" height="43"
                                            editable="true" border="0" alt="" /></a>
                                      </td>
                                    </tr>
                                  </table>
                                  <!-- Logo -->
                                              ...
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td class="fluid-img img-center pb-50"
                                                    ...
                                                    <img
                                                      src="https://cdn-icons-png.flaticon.com/512/10150/10150366.png"
                                                      width="264" height="300" editable="true" border="0"
                                                      alt="" />
                                                  </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                  <td class="text-16 lh-26 a-center pb-25"
                                                    ...
                                                    <multiline>
                                                      We have received your request for your password reset code. Click the button below to enter the code at (eccoemerce.com).
                                                    </multiline>
                                                  </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                      ...
                                                      <tr>
                                                        <td class="title-22 a-center py-20 px-50 mpx-15"
                                                          ...
                                                          bgcolor="#f4ecfa">
                                                          <multiline>
                                                            <strong>CODE : <span class="c-purple"
                                                                style="color:#9128df;">{{ $user->unique_code }}</span></strong>
                                                          </multiline>
                                                        </td>
                                                      </tr>
                                                    </table>
                                                ...
                                                <tr>
                                                  <td align="center">
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0"
                                                      ...
                                                      <tr>
                                                        <td class="btn-16 c-white l-white" bgcolor="#f3189e"
                                                          ...
                                                          <multiline>
                                                            <a href="{{ env('ECOMMERCE_URL') . 'forgot-password' }}"
                                                              ...
                                                              <span class="link c-white"
                                                                style="text-decoration:none; color:#ffffff;">ENTER CODE</span>
                                                            </a>
                                                          </multiline>
                                                        </td>
                                                      </tr>
                                  ...
                                  <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td class="img" width="34"
                                        ...
                                        <a href="#" target="_blank"><img src="../images/ico_facebook.png"
                                            width="34" height="34" editable="true" border="0"
                                            alt="" /></a>
                                      </td>
                                      ...
                                      <td class="img" width="34"
                                        style="font-size:0pt; line-height:0pt; text-align:left;">
                                        <a href="#" target="_blank"><img src="../images/ico_instagram.png"
                                            width="34" height="34" editable="true" border="0"
                                            alt="" /></a>
                                      </td>
                                      <td class="img" width="15"
                                      ...
                                      <td class="img" width="34"
                                        style="font-size:0pt; line-height:0pt; text-align:left;">
                                        <a href="#" target="_blank"><img src="../images/ico_twitter.png"
                                            width="34" height="34" editable="true" border="0"
                                            alt="" /></a>
                                      </td>
                                      <td class="img" width="15"
                                      ...
                                      <td class="img" width="34"
                                        style="font-size:0pt; line-height:0pt; text-align:left;">
                                        <a href="#" target="_blank"><img src="../images/ico_pinterest.png"
                                            width="34" height="34" editable="true" border="0"
                                            alt="" /></a>
                                      </td>
                                    </tr>
                              ...
                              <tr>
                                <td class="text-14 lh-24 a-center c-white l-white pb-20"
                                  ...
                                  <multiline>
                                    ...
                                    <br />
                                    <a cm_dontconvertlink href="tel:+17384796719" target="_blank"
                                      class="link c-white" style="text-decoration:none; color:#ffffff;"><span
                                        class="link c-white" style="text-decoration:none; color:#ffffff;">(738)
                                        479-6719</span></a> - <a cm_dontconvertlink href="tel:+13697181973"
                                      target="_blank" class="link c-white"
                                      style="text-decoration:none; color:#ffffff;"><span class="link c-white"
                                        style="text-decoration:none; color:#ffffff;">(369) 718-1973</span></a>
                                    <br />
                                    <a href="mailto:info@website.com" target="_blank" class="link c-white"
                                      style="text-decoration:none; color:#ffffff;"><span class="link c-white"
                                        style="text-decoration:none; color:#ffffff;">info@website.com</span></a> - <a
                                      href="www.website.com" target="_blank" class="link c-white"
                                      style="text-decoration:none; color:#ffffff;"><span class="link c-white"
                                  ...
                                  <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td class="img" width="117"
                                        style="font-size:0pt; line-height:0pt; text-align:left;">
                                        <a href="#" target="_blank"><img src="../images/btn_appstore.png"
                                            width="117" height="40" editable="true" border="0"
                                            alt="" /></a>
                                      </td>
                                      <td class="img" width="15"
                                        style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                      <td class="img" width="117"
                                        style="font-size:0pt; line-height:0pt; text-align:left;">
                                        <a href="#" target="_blank"><img src="../images/btn_gplay.png"
                                            width="117" height="40" editable="true" border="0"
                                            alt="" /></a>
                                      </td>
                                    </tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="text-12 lh-22 a-center c-grey- l-grey py-20"
                            ...
                            <unsubscribe class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span
                                class="link c-grey"
                                style="white-space: nowrap; text-decoration:none; color:#6e6e6e;">UNSUBSCRIBE</span>
                            </unsubscribe> &nbsp;|&nbsp; <webversion class="link c-grey"
                              style="text-decoration:none; color:#6e6e6e;"><span class="link c-grey"
                                style="white-space: nowrap; text-decoration:none; color:#6e6e6e;">WEB VERSION</span>
                            </webversion> &nbsp;|&nbsp; <forwardtoafriend class="link c-grey"
                              style="text-decoration:none; color:#6e6e6e;"><span class="link c-grey"
                                style="white-space: nowrap; text-decoration:none; color:#6e6e6e;">SEND TO A
                                FRIEND</span></forwardtoafriend>
                          </td>
                        </tr>
                      </table> <!-- END Bottom -->
                    </td>
