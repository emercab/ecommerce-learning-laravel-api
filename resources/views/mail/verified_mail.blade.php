                        ...
                        <tr>
                          <td class="text-12 c-grey l-grey a-right py-20"
                            ...
                            <webversion class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span
                                class="link c-grey" style="text-decoration:none; color:#6e6e6e;">View this
                                email in your browser</span></webversion>
                          </td>
                        </tr>
                      </table> <!-- END Top -->
                                                ...
                                                <tr>
                                                  <td class="fluid-img img-center pb-50"
                                                    ...
                                                    <img src="https://cdn-icons-png.flaticon.com/512/5013/5013710.png"
                                                      width="253" height="300" editable="true" border="0"
                                                      alt="" />
                                                  </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0"
                                                      ...
                                                      <tr>
                                                        <td class="btn-16 c-white l-white" bgcolor="#f3189e"
                                                          ...
                                                          <multiline>
                                                            <a href="{{ env('ECOMMERCE_URL') . 'login?code=' . $user->unique_code }}"
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td class="text-14 lh-24 a-center c-white l-white pb-20"
                                  ...
                                  <multiline>
                                    Address name St. 12, City Name, State, Country
                                    Name
                                    <br />
                                    <a cm_dontconvertlink href="tel:+17384796719" target="_blank"
                                      ...
                                      style="text-decoration:none; color:#ffffff;"><span class="link c-white"
                                        style="text-decoration:none; color:#ffffff;">(369)
                                        718-1973</span></a>
                                    <br />
                                    <a href="mailto:info@website.com" target="_blank" class="link c-white"
                                      style="text-decoration:none; color:#ffffff;"><span class="link c-white"
                                        style="text-decoration:none; color:#ffffff;">info@website.com</span></a>
                                    - <a href="www.website.com" target="_blank" class="link c-white"
                                      style="text-decoration:none; color:#ffffff;"><span class="link c-white"
                          ...
                          <td class="text-12 lh-22 a-center c-grey- l-grey py-20"
                            ...
                            <unsubscribe class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span
                              ...
                              style="text-decoration:none; color:#6e6e6e;"><span class="link c-grey"
                                ...
                                VERSION</span></webversion> &nbsp;|&nbsp;
                            <forwardtoafriend class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span
                                class="link c-grey"
                                style="white-space: nowrap; text-decoration:none; color:#6e6e6e;">SEND
                                TO A FRIEND</span></forwardtoafriend>
                          </td>
                        </tr>
                      </table> <!-- END Bottom -->
                    </td>
